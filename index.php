...
$listFAQ = [
    [
        "heading" => "Come state implementando la recente decisione della Corte di giustizia dell'Unione europea (CGUE) relativa al diritto all'oblio?",
    ...
    [
        "heading" => "Come fa Google a proteggere la mia privacy e a tenere le mie informazioni al sicuro?",
    ...
    [
        "heading" => "Perché il mio account è associato a un paese?",
        "Il tuo account è associato a un paese (o territorio) nei Termini di servizio per poter stabilire due cose:",
        "list1" => [
            "heading" => "La società consociata Google che offre i servizi, tratta le tue informazioni ed è responsabile del rispetto delle leggi sulla privacy vigenti. Generalmente Google offre i propri servizi per i consumatori tramite una delle due società seguenti:",
        ...
        "list2" => [
            "heading" => "La versione dei termini che regola il nostro rapporto, che può variare in base alle leggi locali.",
        ],
        "Tieni presente che i servizi Google sono fondamentalmente gli stessi a prescindere dalla società consociata che li offre o dal paese a cui è associato il tuo account.",
    ],
    [
        "heading" => "Stabilire il paese associato al tuo account",
    ...
    [
        "heading" => "Come faccio a rimuovere informazioni su di me dai risultati di ricerca di Google?",
    ...
    [
        "heading" => "Quando faccio clic sui risultati della Ricerca Google, le mie chiavi di ricerca vengono inviate ai siti web?",
...
<body>
    <header>
        <h1>LIST FAQ</h1>
        <?php var_dump($listFAQ); ?>
    </header>

    <main>
        <?php foreach ($listFAQ as $section) {?>
            <ul>
                <?php 
